  ...
  return (
    <div className="demo-card">
      ...
      <p className="demo-description">
        The <code>AnimatedSprite</code> component supports multiple animations
        with frame sequencing, loop control, speed adjustment, and playback
        control via ref.
      </p>
      ...
      <div className="demo-panel">
        ...
        <p className="demo-description">
          Control the sprite animation using the buttons below. Try different
          animations and adjust playback speed.
        </p>
        ...
        <div className="controls">
          <div className="control-group">
            ...
            <div className="control-buttons">
              <button
                className={
                  currentAnimation === "idle" ? "success" : "secondary"
                }
              ...
              <button
                className={
                  currentAnimation === "walk" ? "success" : "secondary"
                }
              ...
              <button
                className={
                  currentAnimation === "attack" ? "success" : "secondary"
                }
...
// Using the ImgAnimatedSprite component
<ImgAnimatedSprite
  ref={spriteRef}
  id="demo-character"
  idle="idle"
      ...
      <div className="demo-panel">
        ...
        <div className="controls">
          <div className="control-group">
            ...
            <p className="demo-description">
              Continuously play from start to end and repeat. Perfect for idle,
              walk, run animations.
            </p>
          </div>
          ...
          <div className="control-group">
            ...
            <p className="demo-description">
              Play once and stop. Can auto-return to idle. Ideal for attacks,
              jumps, death animations.
            </p>
          </div>
          ...
          <div className="control-group">
            ...
            <p className="demo-description">
              Adjust playback speed (0.1x to 10x). Useful for slow-motion or
